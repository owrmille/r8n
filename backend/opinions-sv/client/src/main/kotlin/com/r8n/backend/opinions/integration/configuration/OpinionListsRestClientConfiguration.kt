...
class OpinionListsRestClientConfiguration {
    ...
    fun opinionListDeletionInternalRestClient(
        @Qualifier("opinionListsDeletionInternalRestBaseClient") opinionListsDeletionInternalRestBaseClient: RestClient,
    ): OpinionListsDeletionInternalApi =
        OpinionListDeletionInternalRestClient(opinionListsDeletionInternalRestBaseClient)
